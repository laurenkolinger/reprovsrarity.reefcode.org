...
kbl(.excl, align = c("l", "r"),
    caption = sprintf("Taxa observed at VINPS but absent from the analyzed baseline community, and therefore excluded from the trend analysis (%d taxa).", nrow(.excl))) |>
  kable_styling(bootstrap_options = c("striped", "hover", "condensed"), full_width = FALSE) |>
  column_spec(1, italic = TRUE)
```
...
#| fig-width: 11
#| fig-height: 3.5
#| fig-cap: "VINPS model diagnostics: residuals versus fitted values, a normal Q-Q plot of standardized residuals, and the residual distribution."
...
- Analysis code: {{< downloadthis ../../_includes/_analysis_vinps.qmd dname="analysis_vinps.qmd" label="Download the analysis code (.qmd)" >}}
